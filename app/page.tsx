...
import {
  Github, MapPin, Users, Book, Link as LinkIcon, Twitter, Building, Calendar, Globe
} from "lucide-react";
...
import { DarkModeToggle } from "@/components/ui/DarkModeToggle"; // ✅ FIXED IMPORT
    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 py-12 px-4">
      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        {loading ? (
          ...
          profile && (
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6 max-w-2xl w-full text-gray-900 dark:text-gray-100">
